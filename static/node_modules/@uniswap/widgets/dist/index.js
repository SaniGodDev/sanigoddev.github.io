...
import React__default, { useContext, createContext, useMemo, useState, useEffect, useCallback, useLayoutEffect, forwardRef, Children, useRef, useImperativeHandle, memo, StrictMode } from 'react';
import { atom, useAtom, Provider as Provider$3 } from 'jotai';
import { Percent, Token, WETH9, NativeCurrency, Ether, CurrencyAmount, TradeType, Price as Price$1, Fraction } from '@uniswap/sdk-core';
import { useAtomValue, useUpdateAtom, atomWithReset, useResetAtom } from 'jotai/utils';
...
import { FACTORY_ADDRESS, Pair, computePairAddress, Trade as Trade$2, Route as Route$2, Router } from '@uniswap/v2-sdk';
import { FACTORY_ADDRESS as FACTORY_ADDRESS$1, computePoolAddress, Pool as Pool$1, FeeAmount, Route as Route$1, SwapQuoter, Trade as Trade$3, toHex, SwapRouter } from '@uniswap/v3-sdk';
...
import { Provider as Provider$2 } from 'react-redux';
...
function Trans$1(props) {
  ...
  var values = _objectSpread$p({}, props.values);

  var components = _objectSpread$p({}, props.components);
...
var jsonRpcConnectorAtom = atom(EMPTY_CONNECTOR);
var injectedConnectorAtom = atom(EMPTY_CONNECTOR);
var Web3Context = /*#__PURE__*/createContext(EMPTY_CONTEXT);
function useActiveWeb3React$1() {
  return useContext(Web3Context);
}

function useConnector(connectorAtom, Connector, initializer) {
  var _useAtom = useAtom(connectorAtom),
      _useAtom2 = _slicedToArray(_useAtom, 2),
      connector = _useAtom2[0],
      setConnector = _useAtom2[1];
    ...
    if (initializer) {
      var _initializeConnector = initializeConnector(function (actions) {
        return new Connector(actions, initializer);
          ...
          _initializeConnector2 = _slicedToArray(_initializeConnector, 3),
          _connector = _initializeConnector2[0],
          hooks = _initializeConnector2[1],
          store = _initializeConnector2[2];

      _connector.activate();

      setConnector([_connector, hooks, store]);
    } else {
...
function ActiveWeb3Provider(_ref) {
  var provider = _ref.provider,
      jsonRpcEndpoint = _ref.jsonRpcEndpoint,
      children = _ref.children;
  var Injected = useMemo(function () {
    if (provider) {
      if (JsonRpcProvider.isProvider(provider)) return JsonRpcConnector;

      if (JsonRpcProvider.isProvider(provider.provider)) {
  ...
  var injectedConnector = useConnector(injectedConnectorAtom, Injected, provider);
  var JsonRpc = useMemo(function () {
    if (JsonRpcProvider.isProvider(jsonRpcEndpoint)) return JsonRpcConnector;
    return Url;
  }, [jsonRpcEndpoint]);
  var jsonRpcConnector = useConnector(jsonRpcConnectorAtom, JsonRpc, jsonRpcEndpoint);

  var _ref2 = injectedConnector[1].useIsActive() ? injectedConnector : jsonRpcConnector !== null && jsonRpcConnector !== void 0 ? jsonRpcConnector : EMPTY_CONNECTOR,
      _ref3 = _slicedToArray(_ref2, 2),
      connector = _ref3[0],
      hooks = _ref3[1];

  var library = hooks.useProvider(); // TODO(zzmp): walletconnect returns chainId as a number, so web3-react incorrectly parses it as hex.

  var _useState = useState(hooks.useChainId()),
  ...
  useEffect(function () {
    var stale = false;
    library === null || library === void 0 ? void 0 : library.getNetwork().then(function (_ref4) {
  ...
  var ensNames = hooks.useENSNames();
  var ensName = hooks.useENSName();
  var web3 = useMemo(function () {
  ...
  }, [account, accounts, active, chainId, connector, ensName, ensNames, error, library]); // Log web3 errors to facilitate debugging.
...
new Percent(JSBI.BigInt(1), BIPS_BASE); // used for warning states
...
function useUpdateChainBlock() {
  ...
  var setChainBlock = useUpdateAtom(chainBlockAtom);
  var onBlock = useCallback(function (block) {
    setChainBlock(function (chainBlock) {
      if (chainBlock.chainId === chainId) {
        ...
        if (typeof chainBlock.block !== 'number') return {
          chainId: chainId,
          block: block
        };
        return {
          chainId: chainId,
          block: Math.max(block, chainBlock.block)
        };
      }
  ...
  useEffect(function () {
    if (library && chainId && windowVisible) {
      ...
      setChainBlock(function (chainBlock) {
        return chainBlock.chainId === chainId ? chainBlock : {
          chainId: chainId
        };
      });
...
function useBlockNumber() {
  var _useActiveWeb3React2 = useActiveWeb3React(),
      activeChainId = _useActiveWeb3React2.chainId;

  var _useAtomValue = useAtomValue(chainBlockAtom),
      chainId = _useAtomValue.chainId,
      block = _useAtomValue.block;
...
var SUPPORTED_GAS_ESTIMATE_CHAIN_IDS = [SupportedChainId.MAINNET, SupportedChainId.POLYGON, SupportedChainId.OPTIMISM, SupportedChainId.ARBITRUM_ONE];
/**
 * All the chain IDs that are running the Ethereum protocol.
 */

[SupportedChainId.MAINNET, SupportedChainId.ROPSTEN, SupportedChainId.RINKEBY, SupportedChainId.GOERLI, SupportedChainId.KOVAN, SupportedChainId.POLYGON, SupportedChainId.POLYGON_MUMBAI];
...
var V3_ROUTER_ADDRESS = constructSameAddressMap('0xE592427A0AEce92De3Edee1F18E0157C05861564', [SupportedChainId.OPTIMISM, SupportedChainId.OPTIMISTIC_KOVAN, SupportedChainId.ARBITRUM_ONE, SupportedChainId.ARBITRUM_RINKEBY, SupportedChainId.POLYGON, SupportedChainId.POLYGON_MUMBAI]);
var SWAP_ROUTER_ADDRESSES = constructSameAddressMap('0x68b3465833fb72A70ecDF485E0e4C7bD8665Fc45', [SupportedChainId.OPTIMISM, SupportedChainId.OPTIMISTIC_KOVAN, SupportedChainId.ARBITRUM_ONE, SupportedChainId.ARBITRUM_RINKEBY, SupportedChainId.POLYGON, SupportedChainId.POLYGON_MUMBAI]);
/**
...
var USDC_OPTIMISTIC_KOVAN = new Token(SupportedChainId.OPTIMISTIC_KOVAN, '0x3b8e53b3ab8e01fb57d0c9e893bc4d655aa67d84', 6, 'USDC', 'USD//C');
...
({
  USDC: (_USDC2 = {}, _defineProperty(_USDC2, SupportedChainId.MAINNET, USDC_MAINNET.address), _defineProperty(_USDC2, SupportedChainId.ARBITRUM_ONE, USDC_ARBITRUM.address), _defineProperty(_USDC2, SupportedChainId.OPTIMISM, USDC_OPTIMISM.address), _defineProperty(_USDC2, SupportedChainId.ARBITRUM_RINKEBY, USDC_ARBITRUM_RINKEBY.address), _defineProperty(_USDC2, SupportedChainId.OPTIMISTIC_KOVAN, USDC_OPTIMISTIC_KOVAN.address), _defineProperty(_USDC2, SupportedChainId.POLYGON, USDC_POLYGON.address), _defineProperty(_USDC2, SupportedChainId.POLYGON_MUMBAI, USDC_POLYGON_MUMBAI.address), _defineProperty(_USDC2, SupportedChainId.GOERLI, USDC_GOERLI.address), _defineProperty(_USDC2, SupportedChainId.RINKEBY, USDC_RINKEBY.address), _defineProperty(_USDC2, SupportedChainId.KOVAN, USDC_KOVAN.address), _defineProperty(_USDC2, SupportedChainId.ROPSTEN, USDC_ROPSTEN.address), _USDC2)
});
...
_objectSpread$m(_objectSpread$m({}, WRAPPED_NATIVE_CURRENCIES_ONLY), {}, _defineProperty({}, SupportedChainId.MAINNET, [].concat(_toConsumableArray(WRAPPED_NATIVE_CURRENCIES_ONLY[SupportedChainId.MAINNET]), [DAI, USDC_MAINNET, USDT, WBTC])));
...
var PAIR_INTERFACE = new Interface(abi$4);
var PairState;
...
var POOL_STATE_INTERFACE = new Interface(abi); // Classes are expensive to instantiate, so this caches the recently instantiated pools.
...
var PoolCache = /*#__PURE__*/function () {
  ...
  _createClass(PoolCache, null, [{
    ...
    value: function getPool(tokenA, tokenB, fee, sqrtPriceX96, liquidity, tick) {
      ...
      var pool = new Pool$1(tokenA, tokenB, fee, sqrtPriceX96, liquidity, tick);
...
function computeAllRoutes(currencyIn, currencyOut, pools, chainId) {
  ...
  var _iterator = _createForOfIteratorHelper$2(pools),
      _step;
  ...
  try {
    var _loop = function _loop() {
      ...
      if (outputToken.equals(tokenOut)) {
        allPaths.push(new Route$1([].concat(_toConsumableArray(currentPath), [pool]), startCurrencyIn, currencyOut));
      } else if (maxHops > 1) {
...
function useClientSideV3Trade(tradeType, amountSpecified, otherCurrency) {
  ...
  var _ref = tradeType === TradeType.EXACT_INPUT ? [amountSpecified === null || amountSpecified === void 0 ? void 0 : amountSpecified.currency, otherCurrency] : [otherCurrency, amountSpecified === null || amountSpecified === void 0 ? void 0 : amountSpecified.currency],
      _ref2 = _slicedToArray(_ref, 2),
      currencyIn = _ref2[0],
      currencyOut = _ref2[1];
...
function useUSDCPrice(currency) {
  ...
  return useMemo(function () {
    ...
    if (v2USDCTrade) {
      ...
      return new Price$1(currency, stablecoin, _denominator, _numerator);
    }
...
function useSlippage(trade) {
  var shouldUseAutoSlippage = useAtomValue(autoSlippageAtom);
  var autoSlippage = useAutoSlippageTolerance(shouldUseAutoSlippage ? trade : undefined);
  var maxSlippageValue = useAtomValue(maxSlippageAtom);
...
function computeRoutes(currencyIn, currencyOut, tradeType, quoteResult) {
  ...
  try {
    return quoteResult.route.map(function (route) {
      ...
      return {
        routev3: isV3Route(route) ? new Route$1(route.map(parsePool), parsedCurrencyIn, parsedCurrencyOut) : null,
        routev2: !isV3Route(route) ? new Route$2(route.map(parsePair), parsedCurrencyIn, parsedCurrencyOut) : null,
...
function usePoll(fetch) {
  ...
  var _ref = arguments.length > 2 ? arguments[2] : undefined,
      ...
      staleCallback = _ref.staleCallback,
  ...
  useEffect(function () {
    ...
    var isStale = staleCallback && (entry === null || entry === void 0 ? void 0 : entry.result) !== undefined ? staleCallback(entry.result) : false;
    ...
    function _poll() {
      _poll = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
        var ttl,
            result,
            _args = arguments;
        return _regeneratorRuntime.wrap(function _callee$(_context) {
...
var DistributionPercents = (_DistributionPercents = {}, _defineProperty(_DistributionPercents, SupportedChainId.MAINNET, 10), _defineProperty(_DistributionPercents, SupportedChainId.OPTIMISM, 10), _defineProperty(_DistributionPercents, SupportedChainId.OPTIMISTIC_KOVAN, 10), _defineProperty(_DistributionPercents, SupportedChainId.ARBITRUM_ONE, 25), _defineProperty(_DistributionPercents, SupportedChainId.ARBITRUM_RINKEBY, 25), _DistributionPercents);
...
function useClientSideSmartOrderRouterTrade(tradeType, amountSpecified, otherCurrency) {
  ...
  var _ref2 = tradeType === TradeType.EXACT_INPUT ? [amountSpecified === null || amountSpecified === void 0 ? void 0 : amountSpecified.currency, otherCurrency] : [otherCurrency, amountSpecified === null || amountSpecified === void 0 ? void 0 : amountSpecified.currency],
      _ref3 = _slicedToArray(_ref2, 2),
      currencyIn = _ref3[0],
  ...
  var _useDebounce = useDebounce(useMemo(function () {
  ...
  var getQuoteResult = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var _quoteResult;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            _context.prev = 4;
            _context.next = 7;
            return import('./clientSideSmartOrderRouter-a50e6fee.js');
  ...
  var _ref5 = (_usePoll = usePoll(getQuoteResult, JSON.stringify(queryArgs), {
    ...
    staleCallback: useCallback(function (_ref6) {
      var data = _ref6.data;
...
function useComputeSwapInfo() {
  ...
  var hasAmounts = currencyIn && currencyOut && parsedAmount;
  var trade = useBestTrade(isExactIn ? TradeType.EXACT_INPUT : TradeType.EXACT_OUTPUT, hasAmounts ? parsedAmount : undefined, hasAmounts ? isExactIn ? currencyOut : currencyIn : undefined);
  var amountIn = useMemo(function () {
    var _trade$trade;
  ...
  var amountOut = useMemo(function () {
    var _trade$trade3;
  ...
  var _useCurrencyBalances = useCurrencyBalances(account, useMemo(function () {
  ...
  return useMemo(function () {
    ...
    return _ref2 = {}, _defineProperty(_ref2, Field.INPUT, {
      ...
      balance: balanceOut,
      usdc: outputUSDC
    }), _defineProperty(_ref2, "trade", trade), _defineProperty(_ref2, "slippage", slippage), _defineProperty(_ref2, "impact", impact), _ref2;
  }, [amountIn, amountOut, balanceIn, balanceOut, currencyIn, currencyOut, impact, inputUSDC, outputUSDC, slippage, trade]);
}

var swapInfoAtom = atom((_atom = {}, _defineProperty(_atom, Field.INPUT, {}), _defineProperty(_atom, Field.OUTPUT, {}), _defineProperty(_atom, "trade", {
  state: TradeState.INVALID
}), _defineProperty(_atom, "slippage", {
  auto: true,
  allowed: new Percent(0)
}), _atom));
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            .addSchema(_objectSpread$k(_objectSpread$k({}, schema), {}, {
              $id: schema.$id + '#tokens',
              required: ['tokens']
  ...
  _createClass(WrappedTokenInfo, [{
    ...
    get: function get() {
      ...
      return this._tags = this.tokenInfo.tags.map(function (tagId) {
        return _objectSpread$j(_objectSpread$j({}, listTags[tagId]), {}, {
          id: tagId
        });
      });
    }
...
var chainTokenMapAtom = atom(null);
...
function useSyncTokenList() {
  ...
  var _useAtom = useAtom(chainTokenMapAtom),
      _useAtom2 = _slicedToArray(_useAtom, 2),
      chainTokenMap = _useAtom2[0],
      setChainTokenMap = _useAtom2[1];

  useEffect(function () {
    return setChainTokenMap(null);
  }, [list, setChainTokenMap]);
...
function useSyncTokenDefaults(_ref) {
  ...
  var setToDefaults = useCallback(function () {
    ...
    var defaultSwapState = (_defaultSwapState = {
      amount: ''
    }, _defineProperty(_defaultSwapState, Field.INPUT, defaultInputToken), _defineProperty(_defaultSwapState, Field.OUTPUT, defaultOutputToken), _defineProperty(_defaultSwapState, "independentField", Field.INPUT), _defaultSwapState);
    ...
    updateSwap(function (swap) {
      return _objectSpread$i(_objectSpread$i({}, swap), defaultSwapState);
    });
...
function getDynamicTheme(theme, color) {
  ...
  return _objectSpread$h(_objectSpread$h(_objectSpread$h({}, theme), colors), {}, {
    module: color,
...
var _templateObject$C, _templateObject2$j;
...
var TransitionTextWrapper = styled(TextWrapper)(_templateObject2$j || (_templateObject2$j = _taggedTemplateLiteral(["\n  transition: font-size 0.25s ease-out, line-height 0.25s ease-out;\n"])));
function H2(props) {
  return /*#__PURE__*/jsx(TextWrapper, _objectSpread$g({
...
function TransitionButton(props) {
  ...
  return /*#__PURE__*/jsx(TransitionTextWrapper, _objectSpread$g({
    className: className,
    fontSize: fontSize,
    fontWeight: 500,
...
var lightTheme = _objectSpread$f(_objectSpread$f({
  // surface
  accent: brandLight,
...
var darkTheme = _objectSpread$f(_objectSpread$f({
  // surface
  accent: brandDark,
...
var defaultTheme = _objectSpread$f({
  borderRadius: 1,
  fontFamily: {
...
function ThemeProvider(_ref) {
  ...
  var value = useMemo(function () {
    return toComputedTheme(_objectSpread$f(_objectSpread$f({}, contextTheme), theme));
  }, [contextTheme, theme]);
...
function toComputedTheme(theme) {
  return _objectSpread$f(_objectSpread$f({}, theme), {}, {
...
var _templateObject$B, _templateObject2$i;
var loadingOpacity = 0.6;
var loadingCss = css(_templateObject$B || (_templateObject$B = _taggedTemplateLiteral(["\n  filter: grayscale(1);\n  opacity: ", ";\n"])), loadingOpacity); // need to use isLoading as `loading` is a reserved prop

var loadingTransitionCss = css(_templateObject2$i || (_templateObject2$i = _taggedTemplateLiteral(["\n  ", ";\n  transition: opacity ", "s ease-in-out;\n"])), function (_ref) {
  var isLoading = _ref.isLoading;
  return isLoading && loadingCss;
}, function (_ref2) {
  var isLoading = _ref2.isLoading;
  return isLoading ? 0 : 0.2;
});

var _templateObject$A, _templateObject2$h, _templateObject3$c, _templateObject4$8, _templateObject5$4, _templateObject6$2, _templateObject7, _templateObject8, _templateObject9, _templateObject10;

function ownKeys$e(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function _objectSpread$e(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$e(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$e(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var StyledImage = styled.img(_templateObject$A || (_templateObject$A = _taggedTemplateLiteral(["\n  height: 1em;\n  width: 1em;\n"])));

function icon(Icon) {
  return styled(Icon)(_templateObject2$h || (_templateObject2$h = _taggedTemplateLiteral(["\n    clip-path: stroke-box;\n    height: 1em;\n    stroke: ", ";\n    width: 1em;\n  "])), function (_ref) {
    var _ref$color = _ref.color,
        color = _ref$color === void 0 ? 'currentColor' : _ref$color,
        theme = _ref.theme;
    return theme[color];
...
var LargeWrapper = styled.div(_templateObject4$8 || (_templateObject4$8 = _taggedTemplateLiteral(["\n  height: 1em;\n  width: ", "em;\n  ", "\n"])), function (_ref4) {
...
var MissingToken = function MissingToken(props) {
  return /*#__PURE__*/jsx(StyledImage, _objectSpread$e({
    src: MissingTokenIcon,
    alt: "Missing token"
  }, props));
};
var Check = styled(icon(SvgCheck))(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral(["\n  circle {\n    fill: ", ";\n    stroke: none;\n  }\n"])), function (_ref6) {
  var theme = _ref6.theme;
  return theme.active;
});
var Expando$1 = styled(icon(SvgExpando))(_templateObject6$2 || (_templateObject6$2 = _taggedTemplateLiteral(["\n  .left,\n  .right {\n    transition: transform 0.25s ease-in-out;\n    will-change: transform;\n  }\n\n  .left {\n    transform: ", ";\n  }\n\n  .right {\n    transform: ", ";\n  }\n"])), function (_ref7) {
  var open = _ref7.open;
...
var Logo = styled(icon(SvgLogo))(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["\n  fill: ", ";\n  stroke: none;\n"])), function (_ref9) {
  var theme = _ref9.theme;
  return theme.secondary;
});
var rotate = keyframes(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n  from {\n    transform: rotate(0deg);\n  }\n  to {\n    transform: rotate(360deg);\n  }\n"])));
...
var _templateObject$z, _templateObject2$g, _templateObject3$b;

function ownKeys$d(object, enumerableOnly) { var keys = Object.keys(object); if (Object.getOwnPropertySymbols) { var symbols = Object.getOwnPropertySymbols(object); enumerableOnly && (symbols = symbols.filter(function (sym) { return Object.getOwnPropertyDescriptor(object, sym).enumerable; })), keys.push.apply(keys, symbols); } return keys; }

function _objectSpread$d(target) { for (var i = 1; i < arguments.length; i++) { var source = null != arguments[i] ? arguments[i] : {}; i % 2 ? ownKeys$d(Object(source), !0).forEach(function (key) { _defineProperty(target, key, source[key]); }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(target, Object.getOwnPropertyDescriptors(source)) : ownKeys$d(Object(source)).forEach(function (key) { Object.defineProperty(target, key, Object.getOwnPropertyDescriptor(source, key)); }); } return target; }
var BaseButton = styled.button(_templateObject$z || (_templateObject$z = _taggedTemplateLiteral(["\n  background-color: transparent;\n  border: none;\n  border-radius: 0.5em;\n  color: currentColor;\n  cursor: pointer;\n  font-size: inherit;\n  font-weight: inherit;\n  height: inherit;\n  line-height: inherit;\n  margin: 0;\n  padding: 0;\n\n  :disabled {\n    cursor: initial;\n    filter: saturate(0) opacity(0.4);\n  }\n"])));
var Button$1 = styled(BaseButton)(_templateObject2$g || (_templateObject2$g = _taggedTemplateLiteral(["\n  color: ", ";\n\n  :enabled {\n    background-color: ", ";\n  }\n\n  :enabled:hover {\n    background-color: ", ";\n  }\n\n  :disabled {\n    border: 1px solid ", ";\n    color: ", ";\n    cursor: initial;\n  }\n"])), function (_ref) {
  var _ref$color = _ref.color,
...
var IconButton = /*#__PURE__*/forwardRef(function IconButton(_ref8, ref) {
  ...
  return /*#__PURE__*/jsx(SecondaryButton, _objectSpread$d(_objectSpread$d({}, props), {}, {
    ref: ref,
    children: /*#__PURE__*/jsx(Icon, _objectSpread$d({}, iconProps))
  }));
});

var _templateObject$y;
var Column = styled.div(_templateObject$y || (_templateObject$y = _taggedTemplateLiteral(["\n  align-items: ", ";\n  color: ", ";\n  display: ", ";\n  flex-direction: column;\n  flex-grow: ", ";\n  gap: ", ";\n  grid-auto-flow: row;\n  grid-template-columns: 1fr;\n  justify-content: ", ";\n  padding: ", ";\n\n  ", "\n"])), function (_ref) {
...
var Row = styled.div(_templateObject$x || (_templateObject$x = _taggedTemplateLiteral(["\n  align-items: ", ";\n  color: ", ";\n  display: ", ";\n  flex-flow: wrap;\n  flex-grow: ", ";\n  gap: ", ";\n  grid-auto-flow: column;\n  grid-template-columns: ", ";\n  justify-content: ", ";\n  padding: ", ";\n"])), function (_ref) {
  var align = _ref.align;
  return align !== null && align !== void 0 ? align : 'center';
}, function (_ref2) {
  var color = _ref2.color,
...
var HeaderRow = styled(Row)(_templateObject$w || (_templateObject$w = _taggedTemplateLiteral(["\n  height: 1.75em;\n  margin: 0 0.75em 0.75em;\n  padding-top: 0.5em;\n  ", "\n"])), largeIconCss);
...
function Header$1(_ref2) {
  ...
  return /*#__PURE__*/jsx(Fragment, {
    children: /*#__PURE__*/jsxs(Column, {
      children: [/*#__PURE__*/jsxs(Header$2, {
        title: title,
...
var Modal = styled.div(_templateObject$u || (_templateObject$u = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border-radius: ", "em;\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n  left: 0;\n  overflow: hidden;\n  position: absolute;\n  top: 0;\n  width: 100%;\n  z-index: ", ";\n"])), function (_ref3) {
...
var _templateObject$t, _templateObject2$f, _templateObject3$a;
...
var PopoverContainer = styled.div(_templateObject$t || (_templateObject$t = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: 0.5em;\n  opacity: ", ";\n  padding: 10px 12px;\n  transition: visibility 0.25s linear, opacity 0.25s linear;\n  visibility: ", ";\n  z-index: ", ";\n"])), function (_ref) {
  var theme = _ref.theme;
  return theme.dialog;
}, function (_ref2) {
...
var Reference = styled.div(_templateObject2$f || (_templateObject2$f = _taggedTemplateLiteral(["\n  align-self: flex-start;\n  display: inline-block;\n  height: 1em;\n"])));
...
function Popover(_ref5) {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Reference, {
      ref: reference,
      children: children
    }), boundary && /*#__PURE__*/createPortal( /*#__PURE__*/jsxs(PopoverContainer, _objectSpread$c(_objectSpread$c({
      show: show,
      ref: setPopover,
      style: styles.popper
    }, attributes.popper), {}, {
      children: [content, /*#__PURE__*/jsx(Arrow, _objectSpread$c({
...
function TokenImg(_ref) {
  ...
  var tokenInfo = (_useToken = useToken(token.isToken ? token.wrapped.address : undefined)) !== null && _useToken !== void 0 ? _useToken : token; // TODO(zzmp): TokenImg takes a frame to switch.
  ...
  return useMemo(function () {
    ...
    if (!src) return /*#__PURE__*/jsx(MissingToken, _objectSpread$b({
      color: "secondary"
    }, rest));
    var alt = tokenInfo.name || tokenInfo.symbol;
    return /*#__PURE__*/jsx("img", _objectSpread$b({
      src: src,
      alt: alt,
      onError: onError
    }, rest), alt);
...
var StringInput = /*#__PURE__*/forwardRef(function StringInput(_ref2, ref) {
  ...
  return /*#__PURE__*/jsx(Input$2, _objectSpread$a({
    value: value,
...
var IntegerInput = /*#__PURE__*/forwardRef(function IntegerInput(props, ref) {
  return /*#__PURE__*/jsx(NumericInput, _objectSpread$a({
    pattern: "^[0-9]*$",
...
var inputCss = css(_templateObject2$e || (_templateObject2$e = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border: 1px solid ", ";\n  border-radius: ", "em;\n  cursor: text;\n  padding: calc(0.5em - 1px);\n\n  :hover:not(:focus-within) {\n    background-color: ", ";\n    border-color: ", ";\n  }\n\n  :focus-within {\n    border-color: ", ";\n  }\n"])), function (_ref4) {
  var theme = _ref4.theme;
...
function processTokens(tokens) {
  ...
  return tokens.map(function (token) {
    ...
    return [token.arg, token.type, _objectSpread$9({
      offset: offset
    }, formatProps)];
  });
...
var TokenButtonRow = styled(Row)(_templateObject2$d || (_templateObject2$d = _taggedTemplateLiteral(["\n  height: 1.2em;\n  // max-width must have an absolute value in order to transition.\n  max-width: ", ";\n  overflow: hidden;\n  transition: max-width 0.25s linear;\n\n  img {\n    min-width: 1.2em;\n  }\n"])), function (_ref4) {
...
function useScrollbar(element) {
  ...
  return useMemo( // NB: The css must be applied on an element's first render. WebKit will not re-apply overflow
...
var TokenBalance = styled.div(_templateObject4$7 || (_templateObject4$7 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border-radius: 0.25em;\n  padding: 0.375em 0;\n"])), function (_ref6) {
  var theme = _ref6.theme,
...
var _templateObject$m, _templateObject2$a, _templateObject3$8, _templateObject4$6, _templateObject5$3;
var Img = styled.div(_templateObject$m || (_templateObject$m = _taggedTemplateLiteral(["\n  clip-path: circle(50%);\n  height: 1.5em;\n  width: 1.5em;\n"])));

var _Symbol = styled.div(_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral(["\n  height: 0.75em;\n  width: 7em;\n"])));

var Name = styled.div(_templateObject3$8 || (_templateObject3$8 = _taggedTemplateLiteral(["\n  height: 0.5em;\n  width: 5.5em;\n"])));
var Balance$1 = styled.div(_templateObject4$6 || (_templateObject4$6 = _taggedTemplateLiteral(["\n  padding: 0.375em 0;\n  width: 1.5em;\n"])));
var TokenRow = styled.div(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n  outline: none;\n  padding: 0.6875em 0.75em;\n\n  ", ", ", ", ", ", ", " {\n    background-color: ", ";\n    border-radius: 0.25em;\n  }\n"])), Img, _Symbol, Name, Balance$1, function (_ref) {
  var theme = _ref.theme;
  return theme.secondary;
});
...
function TokenSelectDialog(_ref) {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    ...
    }), isLoaded ? tokens.length ? /*#__PURE__*/jsx(TokenOptions, {
      tokens: tokens,
      onSelect: onSelect,
      ref: setOptions
    }) : /*#__PURE__*/jsx(Column, {
...
var TokenSelect = /*#__PURE__*/memo(function TokenSelect(_ref2) {
  var value = _ref2.value,
...
var _templateObject$k, _templateObject2$9, _templateObject3$7, _templateObject4$5;
var TokenInputRow = styled(Row)(_templateObject$k || (_templateObject$k = _taggedTemplateLiteral(["\n  grid-template-columns: 1fr;\n"])));
var ValueInput = styled(DecimalInput)(_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral(["\n  color: ", ";\n  height: 1em;\n\n  :hover:not(:focus-within) {\n    color: ", ";\n  }\n\n  :hover:not(:focus-within)::placeholder {\n    color: ", ";\n  }\n\n  ", "\n"])), function (_ref) {
  var theme = _ref.theme;
...
var MaxButton = styled(Button$1)(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["\n  animation: ", " 0.25s linear;\n  border-radius: 0.75em;\n  padding: 0.5em;\n"])), delayedFadeIn);
...
var _templateObject$j, _templateObject2$8, _templateObject3$6;
var USDC = styled(Row)(_templateObject$j || (_templateObject$j = _taggedTemplateLiteral(["\n  ", ";\n"])), loadingTransitionCss);
var Balance = styled(Body2)(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["\n  opacity: ", ";\n  transition: opacity 0.25s ", ";\n"])), function (_ref) {
...
function Input$1(_ref5) {
  ...
  var _useSwapInfo = useSwapInfo(),
      ...
      balance = _useSwapInfo$Field$IN.balance,
      tradeCurrencyAmount = _useSwapInfo$Field$IN.amount,
      usdc = _useSwapInfo$Field$IN.usdc,
      ...
      children: /*#__PURE__*/jsx(Body2, {
        ...
        children: /*#__PURE__*/jsxs(Row, {
          children: [/*#__PURE__*/jsx(USDC, {
            ...
            children: usdc ? "$".concat(formatCurrencyAmount(usdc, 6, 'en', 2)) : '-'
...
function ExternalLink(_ref) {
  ...
  return /*#__PURE__*/jsx("a", _objectSpread$8(_objectSpread$8({
    target: target,
    rel: rel,
    href: href
  }, rest), {}, {
...
function Output(_ref5) {
  ...
  var _useSwapInfo = useSwapInfo(),
      ...
      balance = _useSwapInfo$Field$OU.balance,
      outputCurrencyAmount = _useSwapInfo$Field$OU.amount,
        ...
        children: /*#__PURE__*/jsx(Body2, {
          ...
          children: /*#__PURE__*/jsxs(Row, {
            children: [/*#__PURE__*/jsxs(USDC, {
              gap: 0.5,
              isLoading: isRouteLoading,
              children: [outputUSDC ? "$".concat(formatCurrencyAmount(outputUSDC, 6, 'en', 2)) : '-', ' ', impact && /*#__PURE__*/jsxs(Body2, {
                color: impact.warning,
                children: ["(", impact.toString(), ")"]
              })]
            }), balance && /*#__PURE__*/jsxs(Balance, {
              focused: focused,
              children: ["Balance: ", /*#__PURE__*/jsx("span", {
...
var _templateObject$g, _templateObject2$7, _templateObject3$5, _templateObject4$4, _templateObject5$2;
var ReverseRow = styled(Row)(_templateObject$g || (_templateObject$g = _taggedTemplateLiteral(["\n  left: 50%;\n  position: absolute;\n  transform: translate(-50%, -50%);\n  z-index: ", ";\n"])), Layer.OVERLAY);
var ArrowUp = styled(ArrowUp$1)(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["\n  left: calc(50% - 0.37em);\n  position: absolute;\n  top: calc(50% - 0.82em);\n"])));
...
var Overlay$1 = styled.div(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border-radius: ", "em;\n  padding: 0.25em;\n"])), function (_ref) {
  var theme = _ref.theme;
  return theme.container;
}, function (_ref2) {
  var theme = _ref2.theme;
...
var StyledReverseButton = styled(Button$1)(_templateObject5$2 || (_templateObject5$2 = _taggedTemplateLiteral(["\n  border-radius: ", "em;\n  height: 2.5em;\n  position: relative;\n  width: 2.5em;\n\n  div {\n    transform: rotate(", "turn);\n    transition: transform 0.25s ease-in-out;\n    will-change: transform;\n  }\n"])), function (_ref3) {
  var theme = _ref3.theme;
  return theme.borderRadius * 0.75;
}, function (_ref4) {
...
var _templateObject$d, _templateObject2$6;
...
var Custom = styled(BaseButton)(_templateObject2$6 || (_templateObject2$6 = _taggedTemplateLiteral(["\n  ", "\n  ", "\n  padding: calc(0.75em - 3px) 0.625em;\n"])), function (_ref2) {
...
var _templateObject$a, _templateObject2$5, _templateObject3$4, _templateObject4$3, _templateObject5$1, _templateObject6$1;
var fadeIn = keyframes(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n  from {\n    opacity: 0;\n  }\n  to {\n    opacity: 1;\n  }\n"])));
var StyledButton = styled(Button$1)(_templateObject2$5 || (_templateObject2$5 = _taggedTemplateLiteral(["\n  animation: ", " 0.25s ease-in;\n  border-radius: ", "em;\n  flex-grow: 1;\n  transition: background-color 0.25s ease-out, border-radius 0.25s ease-out, flex-grow 0.25s ease-out;\n\n  :disabled {\n    margin: -1px;\n  }\n"])), fadeIn, function (_ref) {
  var theme = _ref.theme;
  return theme.borderRadius * 0.75;
});
var ActionRow = styled(Row)(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral([""])));
var grow = keyframes(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n  from {\n    opacity: 0;\n    width: 0;\n  }\n  to {\n    opacity: 1;\n    width: max-content;\n  }\n"])));
var actionCss = css(_templateObject5$1 || (_templateObject5$1 = _taggedTemplateLiteral(["\n  border: 1px solid ", ";\n  padding: calc(0.25em - 1px);\n  padding-left: calc(0.75em - 1px);\n\n  ", " {\n    animation: ", " 0.25s ease-in;\n    flex-grow: 1;\n    justify-content: flex-start;\n    white-space: nowrap;\n  }\n\n  ", " {\n    border-radius: ", "em;\n    flex-grow: 0;\n    padding: 1em;\n  }\n"])), function (_ref2) {
  var theme = _ref2.theme;
  return theme.outline;
...
var Overlay = styled(Row)(_templateObject6$1 || (_templateObject6$1 = _taggedTemplateLiteral(["\n  border-radius: ", "em;\n  flex-direction: row-reverse;\n  min-height: 3.5em;\n  transition: padding 0.25s ease-out;\n\n  ", "\n"])), function (_ref4) {
  var theme = _ref4.theme;
  return theme.borderRadius;
}, function (_ref5) {
...
function ActionButton(_ref6) {
  ...
  return /*#__PURE__*/jsxs(Overlay, {
    ...
    flex: true,
    align: "stretch",
    children: [(action ? action.onClick : true) && /*#__PURE__*/jsx(StyledButton, {
      color: color,
      disabled: disabled,
...
var HeaderColumn = styled(Column)(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n  transition: gap 0.25s;\n"])));
var ExpandoColumn = styled(Column)(_templateObject2$4 || (_templateObject2$4 = _taggedTemplateLiteral(["\n  height: ", "em;\n  overflow: hidden;\n  position: relative;\n  transition: height 0.25s, padding 0.25s;\n\n  :after {\n    background: linear-gradient(transparent, ", ");\n    bottom: 0;\n    content: '';\n    height: 0.75em;\n    pointer-events: none;\n    position: absolute;\n    width: calc(100% - 1em);\n  }\n"])), function (_ref) {
...
var InnerColumn = styled(Column)(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n  height: ", "em;\n  padding: 0.5em 0;\n"])), function (_ref3) {
...
function Expando(_ref4) {
  ...
  return /*#__PURE__*/jsxs(Column, {
    children: [/*#__PURE__*/jsxs(HeaderColumn, {
      gap: open ? 0.5 : 0.75,
      children: [/*#__PURE__*/jsx(Rule, {}), /*#__PURE__*/jsxs(Row, {
        children: [title, /*#__PURE__*/jsx(IconButton, {
          color: "secondary",
          onClick: onExpand,
          icon: Expando$1,
          iconProps: {
    ...
    }), /*#__PURE__*/jsx(ExpandoColumn, {
      open: open,
      height: height,
      children: /*#__PURE__*/jsx(InnerColumn, {
        flex: true,
        align: "stretch",
        height: height,
        ref: setScrollingEl,
...
var HeaderIcon = styled(LargeIcon)(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n  flex-grow: 1;\n  transition: height 0.25s, width 0.25s;\n\n  svg {\n    transition: height 0.25s, width 0.25s;\n  }\n"])));
...
var StyledExternalLink = styled(ExternalLink)(_templateObject$7 || (_templateObject$7 = _taggedTemplateLiteral(["\n  color: ", ";\n  text-decoration: none;\n"])), function (_ref) {
  var theme = _ref.theme,
      color = _ref.color;
  return theme[color];
});
function EtherscanLink(_ref2) {
  ...
  return /*#__PURE__*/jsx(StyledExternalLink, {
    ...
    children: /*#__PURE__*/jsxs(Row, {
      gap: 0.25,
      children: [children, url && /*#__PURE__*/jsx(Link, {})]
    })
  });
}
    ...
    children: /*#__PURE__*/jsx(Caption$1, {
      children: /*#__PURE__*/jsxs(Row, {
        ...
        children: [formatLocaleNumber({
          ...
          sigFigs: 1,
          locale: i18n.locale
        }), " ", price.baseCurrency.symbol, " =", ' ', formatPrice(price, 6, i18n.locale), " ", price.quoteCurrency.symbol, usdcPrice && /*#__PURE__*/jsxs(Caption$1, {
          color: "secondary",
          children: ["($", formatCurrencyAmount(usdcPrice, 6, 'en', 2), ")"]
        })]
      })
    })
  });
...
var Value = styled.span(_templateObject$6 || (_templateObject$6 = _taggedTemplateLiteral(["\n  color: ", ";\n  white-space: nowrap;\n"])), function (_ref) {
  var color = _ref.color,
      theme = _ref.theme;
  return color && theme[color];
});
...
function Details(_ref3) {
  ...
  var details = useMemo(function () {
    ...
    if (trade.tradeType === TradeType.EXACT_OUTPUT) {
      var localizedMaxSent = formatCurrencyAmount(trade.maximumAmountIn(slippage.allowed), 6, i18n.locale);
      rows.push([
      /*i18n*/
    ...
    if (trade.tradeType === TradeType.EXACT_INPUT) {
      var _localizedMaxSent = formatCurrencyAmount(trade.minimumAmountOut(slippage.allowed), 6, i18n.locale);
    ...
    return rows;
  }, [feeOptions, i18n.locale, impact, inputCurrency, integrator, lpFeeAmount, outputAmount, outputCurrency, slippage, trade]);
...
function TokenValue(_ref) {
  ...
  return /*#__PURE__*/jsxs(Column, {
    ...
    }), usdc && /*#__PURE__*/jsx(Caption$1, {
      color: "secondary",
      userSelect: true,
      children: /*#__PURE__*/jsxs(Row, {
        justify: "flex-start",
        gap: 0.25,
        children: ["$", formatCurrencyAmount(usdc, 6, 'en', 2), children]
      })
    })]
  });
}
...
function Summary(_ref2) {
  ...
  return /*#__PURE__*/jsxs(Row, {
    ...
    children: [/*#__PURE__*/jsx(TokenValue, {
      ...
      input: output,
      usdc: outputUSDC,
      children: impact && /*#__PURE__*/jsxs(Caption$1, {
        color: impact.warning,
        children: ["(", impact.toString(), ")"]
      })
    })]
...
var _templateObject$5, _templateObject2$2, _templateObject3$2, _templateObject4$2;
var Content = styled(Column)(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral([""])));
var Heading = styled(Column)(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral([""])));
var Footing = styled(Column)(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral([""])));
var Body = styled(Column)(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n  height: calc(100% - 2.5em);\n\n  ", ", ", " {\n    flex-grow: 1;\n    transition: flex-grow 0.25s;\n  }\n\n  ", " {\n    margin-bottom: ", ";\n    max-height: ", ";\n    opacity: ", ";\n    transition: max-height 0.25s, margin-bottom 0.25s, opacity 0.15s 0.1s;\n    visibility: ", ";\n  }\n"])), Content, Heading, Footing, function (_ref) {
  var open = _ref.open;
  return open ? '-0.75em' : undefined;
}, function (_ref2) {
  var open = _ref2.open;
  return open ? 0 : '3em';
}, function (_ref3) {
  ...
  var open = _ref4.open;
  return open ? 'hidden' : undefined;
});

function Subhead(_ref5) {
  var impact = _ref5.impact,
      slippage = _ref5.slippage;
  return /*#__PURE__*/jsxs(Row, {
    gap: 0.5,
    children: [impact !== null && impact !== void 0 && impact.warning || slippage.warning ? /*#__PURE__*/jsx(AlertTriangle, {
      ...
      children: impact !== null && impact !== void 0 && impact.warning ? /*#__PURE__*/jsx(Trans, {
        id: "High price impact"
      }) : slippage.warning ? /*#__PURE__*/jsx(Trans, {
        id: "High slippage"
      }) : /*#__PURE__*/jsx(Trans, {
        id: "Swap details"
      })
...
function Estimate(_ref6) {
  var trade = _ref6.trade,
      slippage = _ref6.slippage;
    ...
    switch (trade.tradeType) {
      case TradeType.EXACT_INPUT:
        return /*#__PURE__*/jsx(Trans, {
          ...
          values: {
            0: formatCurrencyAmount(trade.minimumAmountOut(slippage.allowed), 6, i18n.locale),
      ...
      case TradeType.EXACT_OUTPUT:
        return /*#__PURE__*/jsx(Trans, {
          ...
          values: {
            0: formatCurrencyAmount(trade.maximumAmountIn(slippage.allowed), 6, i18n.locale),
...
function ConfirmButton(_ref7) {
  var trade = _ref7.trade,
      highPriceImpact = _ref7.highPriceImpact,
...
function SummaryDialog(_ref9) {
  var trade = _ref9.trade,
      slippage = _ref9.slippage,
      inputUSDC = _ref9.inputUSDC,
      outputUSDC = _ref9.outputUSDC,
      impact = _ref9.impact,
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Header$1, {
      ...
      children: [/*#__PURE__*/jsxs(Heading, {
        ...
        }), /*#__PURE__*/jsx(Footing, {
          children: /*#__PURE__*/jsx(Estimate, {
            trade: trade,
            slippage: slippage
          })
...
function TransactionStatus(_ref2) {
  ...
  return /*#__PURE__*/jsxs(Column, {
    ...
    }), /*#__PURE__*/jsx(Rule, {}), /*#__PURE__*/jsxs(TransactionRow, {
      flex: true,
      children: [/*#__PURE__*/jsx(ButtonSmall, {
              ...
              switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return _context.abrupt("return", library.send('eth_signTypedData_v4', [account, data]).then(splitSignature).then(function (signature) {
                    setSignatureData(_objectSpread$7(_objectSpread$7({
                      v: signature.v,
                      r: signature.r,
                      s: signature.s,
                      deadline: signatureDeadline
    ...
    try {
      switch (optimizedSwapRouter) {
        ...
        case SwapRouterVersion.V2:
          ...
          var v2Route = new Route$2(pairs, trade.inputAmount.currency, trade.outputAmount.currency);
          ...
          return Trade$3.createUncheckedTradeWithMultipleRoutes({
            routes: trade.swaps.map(function (_ref) {
              var route = _ref.route,
                  ...
                  outputAmount = _ref.outputAmount;
              return {
                route: new Route$1(route.pools.filter(function (p) {
...
var useApproveOrPermit = function useApproveOrPermit(trade, allowedSlippage, useIsPendingApproval, amount) {
  ...
  var _useERC20PermitFromTr = useERC20PermitFromTrade(trade, allowedSlippage, deadline),
      ...
      gatherPermitSignature = _useERC20PermitFromTr.gatherPermitSignature; // If permit is supported, trigger a signature, if not create approval transaction.
...
function useSwapCallArguments(trade, allowedSlippage, recipientAddressOrName, signatureData, deadline, feeOptions) {
  ...
  return useMemo(function () {
    ...
    if (trade instanceof Trade$2) {
      ...
      var sharedSwapOptions = _objectSpread$6({
        fee: feeOptions,
        recipient: recipient,
      ...
      var _ref2 = trade instanceof Trade$3 ? SwapRouter.swapCallParameters(trade, _objectSpread$6(_objectSpread$6({}, sharedSwapOptions), {}, {
        deadline: deadline.toString()
      })) : SwapRouter$1.swapCallParameters(trade, _objectSpread$6(_objectSpread$6({}, sharedSwapOptions), {}, {
            ...
            while (1) {
              switch (_context.prev = _context.next) {
                ...
                case 12:
                  ...
                  return _context.abrupt("return", library.getSigner().sendTransaction(_objectSpread$5(_objectSpread$5({
                    from: account,
                    to: address,
                    data: calldata
...
function useSwapCallback(_ref) {
  ...
  var recipient = recipientAddressOrName === null ? account : recipientAddress;
  return useMemo(function () {
    if (!trade || !library || !account || !chainId || !_callback) {
      return {
  ...
  }, [trade, library, account, chainId, _callback, recipient, recipientAddressOrName]);
}
...
function useApprovalData(trade, slippage, currencyAmount) {
  var currency = currencyAmount === null || currencyAmount === void 0 ? void 0 : currencyAmount.currency;

  var _useApproveOrPermit = useApproveOrPermit(trade, slippage.allowed, useIsPendingApproval, currencyAmount),
  ...
  var onApprove = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var transaction;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            setIsPending(true);
            _context.next = 3;
            return handleApproveOrPermit();

          case 3:
            transaction = _context.sent;

            if (transaction) {
              addTransaction(_objectSpread$4({
  ...
  })), [addTransaction, handleApproveOrPermit]); // Reset the pending state if currency changes.

  useEffect(function () {
    return setIsPending(false);
  }, [currency]);
  var approvalHash = usePendingApproval(currency !== null && currency !== void 0 && currency.isToken ? currency : undefined, useSwapRouterAddress(trade));
  var approvalAction = useMemo(function () {
  ...
  return {
    ...
    signatureData: signatureData !== null && signatureData !== void 0 ? signatureData : undefined
  };
}
...
var SwapButton = /*#__PURE__*/memo(function SwapButton(_ref) {
  var disabled = _ref.disabled;
  ...
  var _useSwapInfo = useSwapInfo(),
      ...
      outputUSDC = _useSwapInfo[Field.OUTPUT].usdc,
      trade = _useSwapInfo.trade,
      slippage = _useSwapInfo.slippage,
      impact = _useSwapInfo.impact;

  var feeOptions = useAtomValue(feeOptionsAtom); // TODO(zzmp): Return an optimized trade directly from useSwapInfo.
  ...
  var _useApprovalData = useApprovalData(optimizedTrade, slippage, inputCurrencyAmount),
      approvalAction = _useApprovalData.approvalAction,
      signatureData = _useApprovalData.signatureData;
  ...
  useEffect(function () {
    return setOpen(function (open) {
      return trade.trade ? open : false;
    });
  }, [trade.trade]); // Close the review modal on chain change.
  ...
  var onWrap = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
    var _transaction$value$to, _transaction$value, transaction, postWrap;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return wrapCallback === null || wrapCallback === void 0 ? void 0 : wrapCallback();
  ...
  })), [addTransaction, chainId, setDisplayTxHash, wrapCallback, wrapType]); // Reset the pending state if user updates the swap.

  useEffect(function () {
    return setIsPending(false);
  }, [inputCurrencyAmount, trade]);
  var onSwap = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
    var transaction, postSwap;
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
          ...
          case 6:
            ...
            setDisplayTxHash(transaction.hash); // Set the block containing the response to the oldest valid block to ensure that the
            // completed trade's impact is reflected in future fetched trades.

            transaction.wait(1).then(function (receipt) {
  ...
  var disableSwap = useMemo(function () {
    return disabled || !chainId || wrapType === WrapType.NONE && !optimizedTrade || !(inputCurrencyAmount && inputCurrencyBalance) || inputCurrencyBalance.lessThan(inputCurrencyAmount);
  ...
  var Label = useCallback(function () {
    switch (wrapType) {
  ...
  }, [inputCurrency === null || inputCurrency === void 0 ? void 0 : inputCurrency.symbol, wrapType]);
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(ActionButton, _objectSpread$3(_objectSpread$3({
      ...
      children: /*#__PURE__*/jsx(Label, {})
    })), open && trade.trade && /*#__PURE__*/jsx(Dialog, {
      color: "dialog",
      onClose: onClose,
...
var _templateObject$3, _templateObject2$1, _templateObject3$1, _templateObject4$1, _templateObject5, _templateObject6;
var StyledAutoRouterLabel = styled(ButtonSmall)(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n  @supports (-webkit-background-clip: text) and (-webkit-text-fill-color: transparent) {\n    background-image: linear-gradient(90deg, #2172e5 0%, #54e521 163.16%);\n    -webkit-background-clip: text;\n    -webkit-text-fill-color: transparent;\n  }\n"])));
...
var Dots = styled(SvgDotLine)(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n  color: ", ";\n  position: absolute;\n  z-index: ", ";\n"])), function (_ref2) {
  var theme = _ref2.theme;
  return theme.outline;
}, Layer.UNDERLAYER);
var RouteRow = styled(Row)(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n  flex-wrap: nowrap;\n"])));
var RouteNode = styled(Row)(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border-radius: ", ";\n  margin-left: 1.625em;\n  padding: 0.25em 0.375em;\n  width: max-content;\n"])), function (_ref3) {
  var theme = _ref3.theme;
  return theme.interactive;
}, function (_ref4) {
...
var RouteBadge = styled.div(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n  background-color: ", ";\n  border-radius: ", ";\n  padding: 0.125em;\n"])), function (_ref5) {
  var theme = _ref5.theme;
  return theme.module;
}, function (_ref6) {
...
var RoutePool = styled(RouteNode)(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["\n  margin: 0 0.75em;\n"])));

function Pool(_ref8) {
  var originCurrency = _ref8.originCurrency,
      targetCurrency = _ref8.targetCurrency,
      feeAmount = _ref8.feeAmount;
  return /*#__PURE__*/jsx(RoutePool, {
    children: /*#__PURE__*/jsx(Caption$1, {
      children: /*#__PURE__*/jsxs(Row, {
        gap: 0.25,
        children: [/*#__PURE__*/jsx(TokenImg$1, {
...
function Route(_ref9) {
  ...
  return /*#__PURE__*/jsxs(Row, {
    ...
    children: [/*#__PURE__*/jsx(TokenImg$1, {
      token: originCurrency
    }), /*#__PURE__*/jsxs(RouteRow, {
      flex: true,
      style: {
        position: 'relative'
      },
      children: [/*#__PURE__*/jsx(Dots, {}), /*#__PURE__*/jsx(RouteDetail, {
        route: route
      }), /*#__PURE__*/jsx(RouteRow, {
...
var Loading = styled.span(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n  color: ", ";\n  ", ";\n"])), function (_ref) {
  var theme = _ref.theme;
  return theme.secondary;
}, loadingCss);
...
function Trade(_ref5) {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(Tooltip, {
      ...
      children: /*#__PURE__*/jsxs(Column, {
        gap: 0.75,
        children: [(impact === null || impact === void 0 ? void 0 : impact.warning) && /*#__PURE__*/jsxs(Fragment, {
          children: [/*#__PURE__*/jsxs(Caption$1, {
            children: ["The output amount is estimated at ", impact.toString(), " less than the input amount due to high price impact"]
          }), /*#__PURE__*/jsx(Rule, {})]
        }), /*#__PURE__*/jsx(RoutingDiagram, {
          trade: trade
        })]
      })
    }), /*#__PURE__*/jsx(Price, {
...
var Toolbar = /*#__PURE__*/memo(function Toolbar(_ref) {
  var disabled = _ref.disabled;
  ...
  }, [chainId, disabled, impact, inputAmount, inputBalance, inputCurrency, isAmountPopulated, outputCurrency, outputUSDC, state, trade, wrapType]);
  return /*#__PURE__*/jsxs(Fragment, {
...
function Updaters$1(props) {
  useSyncTokenList(props.tokenList);
  useSyncTokenDefaults(props);
  useSyncConvenienceFee(props);
  return props.disabled ? null : /*#__PURE__*/jsx(SwapInfoUpdater, {});
}
...
function Swap(props) {
  ...
  return /*#__PURE__*/jsxs(Fragment, {
    children: [/*#__PURE__*/jsx(SwapPropValidator, _objectSpread$2({}, props)), /*#__PURE__*/jsx(Updaters$1, _objectSpread$2(_objectSpread$2({}, props), {}, {
      disabled: isDisabled
    })), /*#__PURE__*/jsxs(Header$2, {
      title: /*#__PURE__*/jsx(Trans, {
        id: "Swap"
      }),
...
var slideIn = keyframes(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  from {\n    transform: translateY(calc(100% - 0.25em));\n  }\n"])));
...
function Widget(props) {
  ...
  return /*#__PURE__*/jsx(StrictMode, {
    children: /*#__PURE__*/jsx(ThemeProvider, {
      theme: theme,
      children: /*#__PURE__*/jsx(WidgetWrapper, {
        width: width,
        className: className,
        children: /*#__PURE__*/jsxs(Provider, {
          ...
          children: [/*#__PURE__*/jsx(DialogWrapper, {
            ...
            children: /*#__PURE__*/jsxs(ErrorBoundary, {
              onError: onError,
              children: [/*#__PURE__*/jsx(WidgetsPropsValidator, _objectSpread$1({}, props)), /*#__PURE__*/jsx(Provider$2, {
                store: store,
                children: /*#__PURE__*/jsx(Provider$3, {
                  children: /*#__PURE__*/jsxs(ActiveWeb3Provider, {
                    provider: provider,
